...
sap.ui.define([
    ...
    function (BaseController, API, formatter, JSONModel, MessageToast,Device) {
        "use strict";
        return BaseController.extend("ns.EBilliaApp.controller.MasterDeliveryNotificationsInt", {
            formatter: formatter,
            ...
            onInit: function () {
                ...
                this._oRouter.getRoute("NotificacionEntregaInternacional").attachPatternMatched(this._routePatternMatched, this);
            ...
            onSearch: function (oEvent) {
                ...
                if (sQuery) {
                    ...
                    this._getPurchaseOrdersByNo(sQuery);
                } else {
		...
		_showDetail : function (oItem) {
            ...
            console.log(oItem.getBindingContext("purchaseOrderModel").getProperty("idOrdenCompra"));
			
			this.getRouter().navTo("NotificacionEntregaInternacionalDetail", {
            ...
            _getPurchaseOrdersByNo: function (num) {
                var oModel = this.getModel("user");
                var rol = oModel.getProperty('/rol/id');
                var userId = oModel.getProperty('/id');
                var poModel = this.getModel("purchaseOrderModel");
                ...
                var me = this;
                var path = API.serviceList().GET_ORDENES_CONFIRMADAS_ + `${userId}/${num}`;
                API.Get(path).then(
                    function (respJson, paramw, param3) {
                        poModel.setProperty('/busy', false);
                        if (respJson && respJson.data) {
